...
export type MentionDescendent = Descendent &
  Node & {
...
export type ParagraphDescendent = Descendent &
  Node & {
 ...
 *
 *     Port stores each image as a 5-dimensional representation. The dimensions are:
 *     - t: time
 *     - c: channel
 *     - z: z-stack
 *     - x: x-dimension
...
type Node_MentionDescendent_Fragment = {
  __typename?: "MentionDescendent";
...
type Node_ParagraphDescendent_Fragment = {
  __typename?: "ParagraphDescendent";
  typename: "ParagraphDescendent";
  children?: Array<
    | {
...
export type NodeFragment =
  | Node_MentionDescendent_Fragment
  | Node_ParagraphDescendent_Fragment;

export type LevelDownParagraphFragment = {
  __typename?: "ParagraphDescendent";
  size?: string | null;
  untypedChildren?: any | null;
};

export type LevelDownMentionFragment = {
  __typename?: "MentionDescendent";
  user: string;
};

type LevelDownDescendent_Leaf_Fragment = {
  __typename?: "Leaf";
  bold?: boolean | null;
  italic?: boolean | null;
  code?: boolean | null;
...
type LevelDownDescendent_MentionDescendent_Fragment = {
  __typename?: "MentionDescendent";
  typename: "MentionDescendent";
};

type LevelDownDescendent_ParagraphDescendent_Fragment = {
  __typename?: "ParagraphDescendent";
  typename: "ParagraphDescendent";
};

export type LevelDownDescendentFragment =
  | LevelDownDescendent_Leaf_Fragment
  | LevelDownDescendent_MentionDescendent_Fragment
  | LevelDownDescendent_ParagraphDescendent_Fragment;
...
type Descendent_MentionDescendent_Fragment = {
  __typename?: "MentionDescendent";
  user: string;
  typename: "MentionDescendent";
  children?: Array<
...
type Descendent_ParagraphDescendent_Fragment = {
  __typename?: "ParagraphDescendent";
  size?: string | null;
  typename: "ParagraphDescendent";
  children?: Array<
...
export type DescendentFragment =
  | Descendent_Leaf_Fragment
  | Descendent_MentionDescendent_Fragment
  | Descendent_ParagraphDescendent_Fragment;
...
export type MentionCommentFragment = {
  ...
  createdAt: any;
  objectId: number;
  contentType?: CommentableModels | null;
  user: { __typename?: "User"; email: string };
  parent?: { __typename?: "Comment"; id: string } | null;
  descendents?: Array<
    | {
  ...
  mentions: Array<{ __typename?: "User"; email: string }>;
};

export type DetailExperimentFragment = {
  __typename?: "Experiment";
  id: string;
  name: string;
  ...
  pinnedBy: Array<{ __typename?: "User"; id: string; email: string }>;
};
...
export type OmeroFragment = {
  ...
  channels?: Array<{
    __typename?: "Channel";
    name?: string | null;
    emmissionWavelength?: number | null;
    excitationWavelength?: number | null;
    color?: string | null;
  } | null> | null;
  objectiveSettings?: {
    __typename?: "ObjectiveSettings";
    correctionCollar?: number | null;
    medium?: Medium | null;
  } | null;
  instrument?: {
    __typename?: "Instrument";
...
export type DetailOmeroFileFragment = {
  __typename?: "OmeroFile";
  id: string;
  name: string;
  type: OmeroFileType;
  ...
  derivedRepresentations: Array<{
    ...
    variety: RepresentationVariety;
    pinned?: boolean | null;
    origins: Array<{ __typename?: "Representation"; name?: string | null }>;
    latestThumbnail?: {
      __typename?: "Thumbnail";
      image?: string | null;
    ...
    sample?: {
      __typename?: "Sample";
      name: string;
      experiments: Array<{ __typename?: "Experiment"; name: string }>;
    } | null;
  }>;
};

export type ListOmeroFileFragment = {
  __typename?: "OmeroFile";
  id: string;
  name: string;
  type: OmeroFileType;
...
export type UserAssignmentFragment = {
  __typename?: "UserAssignment";
  permissions: Array<string | null>;
  user: { __typename?: "User"; id: string; username: string; email: string };
};

export type GroupAssignmentFragment = {
  __typename?: "GroupAssignment";
  permissions: Array<string | null>;
...
export type ListRepresentationFragment = {
  __typename?: "Representation";
  name?: string | null;
  id: string;
  variety: RepresentationVariety;
...
export type ListSharedRepresentationFragment = {
  __typename?: "Representation";
  name?: string | null;
  id: string;
  variety: RepresentationVariety;
  origins: Array<{ __typename?: "Representation"; name?: string | null }>;
  latestThumbnail?: { __typename?: "Thumbnail"; image?: string | null } | null;
  sample?: {
    __typename?: "Sample";
    name: string;
    experiments: Array<{ __typename?: "Experiment"; name: string }>;
  } | null;
  creator?: { __typename?: "User"; email: string } | null;
};
...
export type DetailRepresentationFragment = {
  ...
  sample?: { __typename?: "Sample"; id: string; name: string } | null;
  metrics?: Array<{
    __typename?: "Metric";
    id: string;
    key: string;
...
export type DetailSampleFragment = {
  __typename?: "Sample";
  name: string;
  id: string;
  createdAt: any;
...
export type ListSampleFragment = {
  __typename?: "Sample";
  name: string;
  id: string;
  pinned?: boolean | null;
...
export type ColumnFragment = {
  ...
  name?: string | null;
  fieldName: string;
  pandasType?: PandasDType | null;
  numpyType?: string | null;
  metadata?: any | null;
};

export type DetailTableFragment = {
  __typename?: "Table";
  id: string;
  name: string;
  representation?: { __typename?: "Representation"; id: string } | null;
  sample?: { __typename?: "Sample"; id: string } | null;
  experiment?: { __typename?: "Experiment"; id: string } | null;
};
...
export type PinExperimentMutation = {
  __typename?: "Mutation";
  pinExperiment?: {
    __typename?: "Experiment";
    id: string;
...
export type UploadOmeroFileMutation = {
  __typename?: "Mutation";
  uploadOmeroFile?: {
    __typename?: "OmeroFile";
    id: string;
...
export type DeleteOmeroFileMutation = {
  __typename?: "Mutation";
  deleteOmeroFile?: {
    __typename?: "DeleteOmeroFileResult";
    id?: string | null;
...
export type UpdateOmeroFileMutation = {
  __typename?: "Mutation";
  updateOmeroFile?: {
    __typename?: "OmeroFile";
    id: string;
...
export type DeletePlotMutation = {
  __typename?: "Mutation";
  deletePlot?: { __typename?: "DeletePlotResult"; id?: string | null } | null;
};
...
export type DeleteRepresentationMutation = {
  __typename?: "Mutation";
...
export type UpdateRepresentationMutation = {
  __typename?: "Mutation";
...
export type PinRepresentationMutation = {
  __typename?: "Mutation";
  pinRepresentation?: {
    __typename?: "Representation";
    id: string;
...
export type DeleteTableMutation = {
  __typename?: "Mutation";
  deleteTable?: { __typename?: "DeleteTableResult"; id?: string | null } | null;
};
...
export type MyExperimentsQuery = {
  __typename?: "Query";
  myexperiments?: Array<{
    __typename?: "Experiment";
    id: string;
...
export type SearchExperimentsQuery = {
  __typename?: "Query";
  options?: Array<{
    __typename?: "Experiment";
    label: string;
...
export type DetailMetricQuery = {
  __typename?: "Query";
  metric?: { __typename?: "Metric"; key: string; value?: any | null } | null;
};
...
export type DetailOmeroFileQuery = {
  __typename?: "Query";
  omerofile?: {
    __typename?: "OmeroFile";
    id: string;
...
export type PermissionsOfQuery = {
  __typename?: "Query";
  permissionsOf?: {
    __typename?: "PermissionsOfReturn";
    available?: Array<{
...
export type MyRepresentationsQuery = {
  __typename?: "Query";
  myrepresentations?: Array<{
    __typename?: "Representation";
    name?: string | null;
    id: string;
    variety: RepresentationVariety;
...
export type SharedRepresentationsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type SharedRepresentationsQuery = {
  __typename?: "Query";
  sharedrepresentations?: Array<{
    __typename?: "Representation";
    name?: string | null;
    id: string;
    variety: RepresentationVariety;
...
export type RepresentationsForQuery = {
  __typename?: "Query";
  representationsForGroup?: Array<{
    __typename?: "Representation";
    name?: string | null;
    id: string;
    variety: RepresentationVariety;
...
export type RepresentationsForUserQuery = {
  __typename?: "Query";
  representationsForUser?: Array<{
    __typename?: "Representation";
    name?: string | null;
    id: string;
    variety: RepresentationVariety;
...
export type SearchableRepresentationsQuery = {
  __typename?: "Query";
  myrepresentations?: Array<{
    __typename?: "Representation";
    name?: string | null;
...
export type RepresentationFilterSearchQuery = {
  __typename?: "Query";
  Samples?: Array<{
    __typename?: "Sample";
    label: string;
...
export type PinnedRepresentationsQueryVariables = Exact<{
  [key: string]: never;
}>;

export type PinnedRepresentationsQuery = {
  __typename?: "Query";
  representations?: Array<{
    __typename?: "Representation";
    name?: string | null;
...
export type RoisForRepresentationQuery = {
  __typename?: "Query";
  rois?: Array<{
    __typename?: "ROI";
    id: string;
...
export type DetailTableQuery = {
  __typename?: "Query";
  table?: {
    __typename?: "Table";
    query?: Array<any | null> | null;
    id: string;
    name: string;
    columns?: Array<{
      __typename?: "Column";
...
export type MyExperimentsEventSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type MyExperimentsEventSubscription = {
  __typename?: "Subscription";
  myExperiments?: {
    __typename?: "ExperimentsEvent";
    deleted?: string | null;
...
export type MyRepresentationsEventSubscriptionVariables = Exact<{
  [key: string]: never;
}>;
...
export type MySamplesEventSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type MySamplesEventSubscription = {
  __typename?: "Subscription";
  mySamples?: {
    __typename?: "SamplesEvent";
    deleted?: string | null;
...
export type MyTablesEventSubscriptionVariables = Exact<{
  [key: string]: never;
}>;

export type MyTablesEventSubscription = {
  __typename?: "Subscription";
  myTables?: {
    __typename?: "TablesEvent";
    deleted?: string | null;
...
`;
export type PinExperimentMutationFn = Apollo.MutationFunction<
  PinExperimentMutation,
  PinExperimentMutationVariables
>;
 ...
 * });
 */
export function usePinExperimentMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PinExperimentMutation,
    PinExperimentMutationVariables
  >
  ...
  return Apollo.useMutation<
    PinExperimentMutation,
    PinExperimentMutationVariables
  >(PinExperimentDocument, options);
}
export type PinExperimentMutationHookResult = ReturnType<
  typeof usePinExperimentMutation
>;
export type PinExperimentMutationResult =
  Apollo.MutationResult<PinExperimentMutation>;
export type PinExperimentMutationOptions = Apollo.BaseMutationOptions<
  PinExperimentMutation,
  PinExperimentMutationVariables
>;
...
`;
export type UploadOmeroFileMutationFn = Apollo.MutationFunction<
  UploadOmeroFileMutation,
 ...
 * });
 */
export function useUploadOmeroFileMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UploadOmeroFileMutation,
    UploadOmeroFileMutationVariables
  >
  ...
  return Apollo.useMutation<
    UploadOmeroFileMutation,
    UploadOmeroFileMutationVariables
  >(UploadOmeroFileDocument, options);
}
export type UploadOmeroFileMutationHookResult = ReturnType<
  typeof useUploadOmeroFileMutation
>;
export type UploadOmeroFileMutationResult =
  Apollo.MutationResult<UploadOmeroFileMutation>;
export type UploadOmeroFileMutationOptions = Apollo.BaseMutationOptions<
  UploadOmeroFileMutation,
  UploadOmeroFileMutationVariables
>;
...
`;
export type DeleteOmeroFileMutationFn = Apollo.MutationFunction<
  DeleteOmeroFileMutation,
  DeleteOmeroFileMutationVariables
>;
 ...
 * });
 */
export function useDeleteOmeroFileMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteOmeroFileMutation,
    DeleteOmeroFileMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteOmeroFileMutation,
    DeleteOmeroFileMutationVariables
  >(DeleteOmeroFileDocument, options);
}
export type DeleteOmeroFileMutationHookResult = ReturnType<
  typeof useDeleteOmeroFileMutation
>;
export type DeleteOmeroFileMutationResult =
  Apollo.MutationResult<DeleteOmeroFileMutation>;
export type DeleteOmeroFileMutationOptions = Apollo.BaseMutationOptions<
  DeleteOmeroFileMutation,
  DeleteOmeroFileMutationVariables
>;
export const UpdateOmeroFileDocument = gql`
  ...
  ${DetailOmeroFileFragmentDoc}
`;
export type UpdateOmeroFileMutationFn = Apollo.MutationFunction<
  UpdateOmeroFileMutation,
 ...
 * });
 */
export function useUpdateOmeroFileMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateOmeroFileMutation,
    UpdateOmeroFileMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateOmeroFileMutation,
    UpdateOmeroFileMutationVariables
  >(UpdateOmeroFileDocument, options);
}
export type UpdateOmeroFileMutationHookResult = ReturnType<
  typeof useUpdateOmeroFileMutation
>;
export type UpdateOmeroFileMutationResult =
  Apollo.MutationResult<UpdateOmeroFileMutation>;
export type UpdateOmeroFileMutationOptions = Apollo.BaseMutationOptions<
  UpdateOmeroFileMutation,
  UpdateOmeroFileMutationVariables
>;
...
>;
export type CreatePlotMutationResult =
  Apollo.MutationResult<CreatePlotMutation>;
...
`;
export type DeletePlotMutationFn = Apollo.MutationFunction<
  DeletePlotMutation,
  DeletePlotMutationVariables
>;
...
export function useDeletePlotMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<DeletePlotMutation, DeletePlotMutationVariables>(
    DeletePlotDocument,
    options
  );
}
export type DeletePlotMutationHookResult = ReturnType<
  typeof useDeletePlotMutation
>;
export type DeletePlotMutationResult =
  Apollo.MutationResult<DeletePlotMutation>;
export type DeletePlotMutationOptions = Apollo.BaseMutationOptions<
  DeletePlotMutation,
  DeletePlotMutationVariables
>;
...
`;
export type DeleteRepresentationMutationFn = Apollo.MutationFunction<
  DeleteRepresentationMutation,
  DeleteRepresentationMutationVariables
>;
 ...
 * });
 */
export function useDeleteRepresentationMutation(
  baseOptions?: Apollo.MutationHookOptions<
    DeleteRepresentationMutation,
    DeleteRepresentationMutationVariables
  >
  ...
  return Apollo.useMutation<
    DeleteRepresentationMutation,
    DeleteRepresentationMutationVariables
  >(DeleteRepresentationDocument, options);
}
export type DeleteRepresentationMutationHookResult = ReturnType<
  typeof useDeleteRepresentationMutation
>;
export type DeleteRepresentationMutationResult =
  Apollo.MutationResult<DeleteRepresentationMutation>;
export type DeleteRepresentationMutationOptions = Apollo.BaseMutationOptions<
  DeleteRepresentationMutation,
  DeleteRepresentationMutationVariables
>;
...
`;
export type UpdateRepresentationMutationFn = Apollo.MutationFunction<
  UpdateRepresentationMutation,
 ...
 * });
 */
export function useUpdateRepresentationMutation(
  baseOptions?: Apollo.MutationHookOptions<
    UpdateRepresentationMutation,
    UpdateRepresentationMutationVariables
  >
  ...
  return Apollo.useMutation<
    UpdateRepresentationMutation,
    UpdateRepresentationMutationVariables
  >(UpdateRepresentationDocument, options);
}
export type UpdateRepresentationMutationHookResult = ReturnType<
  typeof useUpdateRepresentationMutation
>;
export type UpdateRepresentationMutationResult =
  Apollo.MutationResult<UpdateRepresentationMutation>;
export type UpdateRepresentationMutationOptions = Apollo.BaseMutationOptions<
  UpdateRepresentationMutation,
  UpdateRepresentationMutationVariables
>;
...
`;
export type PinRepresentationMutationFn = Apollo.MutationFunction<
  PinRepresentationMutation,
  PinRepresentationMutationVariables
>;
 ...
 * });
 */
export function usePinRepresentationMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PinRepresentationMutation,
    PinRepresentationMutationVariables
  >
  ...
  return Apollo.useMutation<
    PinRepresentationMutation,
    PinRepresentationMutationVariables
  >(PinRepresentationDocument, options);
}
export type PinRepresentationMutationHookResult = ReturnType<
  typeof usePinRepresentationMutation
>;
export type PinRepresentationMutationResult =
  Apollo.MutationResult<PinRepresentationMutation>;
export type PinRepresentationMutationOptions = Apollo.BaseMutationOptions<
  PinRepresentationMutation,
  PinRepresentationMutationVariables
>;
...
export function usePinRoiMutation(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<PinRoiMutation, PinRoiMutationVariables>(
    PinRoiDocument,
    options
  );
}
...
`;
export type CreateSampleMutationFn = Apollo.MutationFunction<
...
`;
export type DeleteSampleMutationFn = Apollo.MutationFunction<
...
export function useDeleteSampleMutation(
  ...
  return Apollo.useMutation<
    DeleteSampleMutation,
    DeleteSampleMutationVariables
  >(DeleteSampleDocument, options);
}
export type DeleteSampleMutationHookResult = ReturnType<
  typeof useDeleteSampleMutation
>;
export type DeleteSampleMutationResult =
  Apollo.MutationResult<DeleteSampleMutation>;
export type DeleteSampleMutationOptions = Apollo.BaseMutationOptions<
  DeleteSampleMutation,
  DeleteSampleMutationVariables
>;
export const UpdateSampleDocument = gql`
  ...
  ${DetailSampleFragmentDoc}
`;
export type UpdateSampleMutationFn = Apollo.MutationFunction<
...
`;
export type PinSampleMutationFn = Apollo.MutationFunction<
  PinSampleMutation,
  PinSampleMutationVariables
>;
 ...
 * });
 */
export function usePinSampleMutation(
  baseOptions?: Apollo.MutationHookOptions<
    PinSampleMutation,
    PinSampleMutationVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useMutation<PinSampleMutation, PinSampleMutationVariables>(
    PinSampleDocument,
    options
  );
}
export type PinSampleMutationHookResult = ReturnType<
  typeof usePinSampleMutation
>;
export type PinSampleMutationResult = Apollo.MutationResult<PinSampleMutation>;
export type PinSampleMutationOptions = Apollo.BaseMutationOptions<
  PinSampleMutation,
  PinSampleMutationVariables
>;
 ...
 * });
 */
export function useMyExperimentsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MyExperimentsQuery,
    MyExperimentsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyExperimentsQuery, MyExperimentsQueryVariables>(
    MyExperimentsDocument,
    options
  );
}
export function useMyExperimentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyExperimentsQuery,
    MyExperimentsQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyExperimentsQuery, MyExperimentsQueryVariables>(
    MyExperimentsDocument,
    options
  );
}
export type MyExperimentsQueryHookResult = ReturnType<
  typeof useMyExperimentsQuery
>;
export type MyExperimentsLazyQueryHookResult = ReturnType<
  typeof useMyExperimentsLazyQuery
>;
export type MyExperimentsQueryResult = Apollo.QueryResult<
  MyExperimentsQuery,
  MyExperimentsQueryVariables
>;
...
export function useDetailExperimentQuery(
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailExperimentQuery, DetailExperimentQueryVariables>(
...
export function useDetailExperimentLazyQuery(
  ...
  return Apollo.useLazyQuery<
    DetailExperimentQuery,
    DetailExperimentQueryVariables
  >(DetailExperimentDocument, options);
}
export type DetailExperimentQueryHookResult = ReturnType<
  typeof useDetailExperimentQuery
>;
export type DetailExperimentLazyQueryHookResult = ReturnType<
  typeof useDetailExperimentLazyQuery
>;
 ...
 * });
 */
export function useSearchExperimentsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SearchExperimentsQuery,
    SearchExperimentsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SearchExperimentsQuery,
    SearchExperimentsQueryVariables
  >(SearchExperimentsDocument, options);
}
export function useSearchExperimentsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchExperimentsQuery,
    SearchExperimentsQueryVariables
  >
...
export type SearchExperimentsQueryHookResult = ReturnType<
  typeof useSearchExperimentsQuery
>;
export type SearchExperimentsLazyQueryHookResult = ReturnType<
  typeof useSearchExperimentsLazyQuery
>;
export type SearchExperimentsQueryResult = Apollo.QueryResult<
  SearchExperimentsQuery,
  SearchExperimentsQueryVariables
>;
 ...
 * });
 */
export function useDetailMetricQuery(
  baseOptions: Apollo.QueryHookOptions<
    DetailMetricQuery,
    DetailMetricQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailMetricQuery, DetailMetricQueryVariables>(
    DetailMetricDocument,
    options
  );
}
export function useDetailMetricLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailMetricQuery,
    DetailMetricQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DetailMetricQuery, DetailMetricQueryVariables>(
    DetailMetricDocument,
    options
  );
}
export type DetailMetricQueryHookResult = ReturnType<
  typeof useDetailMetricQuery
>;
export type DetailMetricLazyQueryHookResult = ReturnType<
  typeof useDetailMetricLazyQuery
>;
export type DetailMetricQueryResult = Apollo.QueryResult<
  DetailMetricQuery,
  DetailMetricQueryVariables
>;
 ...
 * });
 */
export function useMyOmeroFilesQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MyOmeroFilesQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyOmeroFilesQuery, MyOmeroFilesQueryVariables>(
    MyOmeroFilesDocument,
    options
  );
}
export function useMyOmeroFilesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyOmeroFilesQuery,
    MyOmeroFilesQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyOmeroFilesQuery, MyOmeroFilesQueryVariables>(
    MyOmeroFilesDocument,
    options
  );
}
export type MyOmeroFilesQueryHookResult = ReturnType<
  typeof useMyOmeroFilesQuery
>;
export type MyOmeroFilesLazyQueryHookResult = ReturnType<
  typeof useMyOmeroFilesLazyQuery
>;
export type MyOmeroFilesQueryResult = Apollo.QueryResult<
  MyOmeroFilesQuery,
  MyOmeroFilesQueryVariables
>;
 ...
 * });
 */
export function useDetailOmeroFileQuery(
  baseOptions: Apollo.QueryHookOptions<
    DetailOmeroFileQuery,
    DetailOmeroFileQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailOmeroFileQuery, DetailOmeroFileQueryVariables>(
    DetailOmeroFileDocument,
    options
  );
}
export function useDetailOmeroFileLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailOmeroFileQuery,
    DetailOmeroFileQueryVariables
  >
  ...
  return Apollo.useLazyQuery<
    DetailOmeroFileQuery,
    DetailOmeroFileQueryVariables
  >(DetailOmeroFileDocument, options);
}
export type DetailOmeroFileQueryHookResult = ReturnType<
  typeof useDetailOmeroFileQuery
>;
export type DetailOmeroFileLazyQueryHookResult = ReturnType<
  typeof useDetailOmeroFileLazyQuery
>;
export type DetailOmeroFileQueryResult = Apollo.QueryResult<
  DetailOmeroFileQuery,
  DetailOmeroFileQueryVariables
>;
...
export function usePermissionOptionsQuery(
  ...
  return Apollo.useQuery<
    PermissionOptionsQuery,
    PermissionOptionsQueryVariables
  >(PermissionOptionsDocument, options);
}
...
export type PermissionOptionsQueryHookResult = ReturnType<
  typeof usePermissionOptionsQuery
>;
export type PermissionOptionsLazyQueryHookResult = ReturnType<
  typeof usePermissionOptionsLazyQuery
>;
 ...
 * });
 */
export function usePermissionsOfQuery(
  baseOptions: Apollo.QueryHookOptions<
    PermissionsOfQuery,
    PermissionsOfQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<PermissionsOfQuery, PermissionsOfQueryVariables>(
    PermissionsOfDocument,
    options
  );
}
export function usePermissionsOfLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    PermissionsOfQuery,
    PermissionsOfQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<PermissionsOfQuery, PermissionsOfQueryVariables>(
    PermissionsOfDocument,
    options
  );
}
export type PermissionsOfQueryHookResult = ReturnType<
  typeof usePermissionsOfQuery
>;
export type PermissionsOfLazyQueryHookResult = ReturnType<
  typeof usePermissionsOfLazyQuery
>;
export type PermissionsOfQueryResult = Apollo.QueryResult<
  PermissionsOfQuery,
  PermissionsOfQueryVariables
>;
 ...
 * });
 */
export function useDetailPlotQuery(
  baseOptions: Apollo.QueryHookOptions<
    DetailPlotQuery,
    DetailPlotQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailPlotQuery, DetailPlotQueryVariables>(
    DetailPlotDocument,
    options
  );
}
export function useDetailPlotLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailPlotQuery,
    DetailPlotQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DetailPlotQuery, DetailPlotQueryVariables>(
    DetailPlotDocument,
    options
  );
}
export type DetailPlotQueryHookResult = ReturnType<typeof useDetailPlotQuery>;
export type DetailPlotLazyQueryHookResult = ReturnType<
  typeof useDetailPlotLazyQuery
>;
export type DetailPlotQueryResult = Apollo.QueryResult<
  DetailPlotQuery,
  DetailPlotQueryVariables
>;
 ...
 * });
 */
export function useMyPlotsQuery(
  baseOptions?: Apollo.QueryHookOptions<MyPlotsQuery, MyPlotsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyPlotsQuery, MyPlotsQueryVariables>(
    MyPlotsDocument,
    options
  );
}
export function useMyPlotsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<MyPlotsQuery, MyPlotsQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyPlotsQuery, MyPlotsQueryVariables>(
    MyPlotsDocument,
    options
  );
}
...
export type MyPlotsQueryResult = Apollo.QueryResult<
  MyPlotsQuery,
  MyPlotsQueryVariables
>;
 ...
 * });
 */
export function useDetailRepresentationQuery(
  baseOptions: Apollo.QueryHookOptions<
    DetailRepresentationQuery,
    DetailRepresentationQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    DetailRepresentationQuery,
    DetailRepresentationQueryVariables
  >(DetailRepresentationDocument, options);
}
export function useDetailRepresentationLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailRepresentationQuery,
    DetailRepresentationQueryVariables
  >
...
export type DetailRepresentationQueryHookResult = ReturnType<
  typeof useDetailRepresentationQuery
>;
export type DetailRepresentationLazyQueryHookResult = ReturnType<
  typeof useDetailRepresentationLazyQuery
>;
export type DetailRepresentationQueryResult = Apollo.QueryResult<
  DetailRepresentationQuery,
  DetailRepresentationQueryVariables
>;
 ...
 * });
 */
export function useMyRepresentationsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    MyRepresentationsQuery,
    MyRepresentationsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    MyRepresentationsQuery,
    MyRepresentationsQueryVariables
  >(MyRepresentationsDocument, options);
}
export function useMyRepresentationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyRepresentationsQuery,
    MyRepresentationsQueryVariables
  >
...
export type MyRepresentationsQueryHookResult = ReturnType<
  typeof useMyRepresentationsQuery
>;
export type MyRepresentationsLazyQueryHookResult = ReturnType<
  typeof useMyRepresentationsLazyQuery
>;
export type MyRepresentationsQueryResult = Apollo.QueryResult<
  MyRepresentationsQuery,
  MyRepresentationsQueryVariables
>;
 ...
 * });
 */
export function useSharedRepresentationsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SharedRepresentationsQuery,
    SharedRepresentationsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SharedRepresentationsQuery,
    SharedRepresentationsQueryVariables
  >(SharedRepresentationsDocument, options);
}
export function useSharedRepresentationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SharedRepresentationsQuery,
    SharedRepresentationsQueryVariables
  >
...
export type SharedRepresentationsQueryHookResult = ReturnType<
  typeof useSharedRepresentationsQuery
>;
export type SharedRepresentationsLazyQueryHookResult = ReturnType<
  typeof useSharedRepresentationsLazyQuery
>;
export type SharedRepresentationsQueryResult = Apollo.QueryResult<
  SharedRepresentationsQuery,
  SharedRepresentationsQueryVariables
>;
 ...
 * });
 */
export function useRepresentationsForQuery(
  baseOptions: Apollo.QueryHookOptions<
    RepresentationsForQuery,
    RepresentationsForQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    RepresentationsForQuery,
    RepresentationsForQueryVariables
  >(RepresentationsForDocument, options);
}
export function useRepresentationsForLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RepresentationsForQuery,
    RepresentationsForQueryVariables
  >
...
export type RepresentationsForQueryHookResult = ReturnType<
  typeof useRepresentationsForQuery
>;
export type RepresentationsForLazyQueryHookResult = ReturnType<
  typeof useRepresentationsForLazyQuery
>;
export type RepresentationsForQueryResult = Apollo.QueryResult<
  RepresentationsForQuery,
  RepresentationsForQueryVariables
>;
 ...
 * });
 */
export function useRepresentationsForUserQuery(
  baseOptions: Apollo.QueryHookOptions<
    RepresentationsForUserQuery,
    RepresentationsForUserQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    RepresentationsForUserQuery,
    RepresentationsForUserQueryVariables
  >(RepresentationsForUserDocument, options);
}
export function useRepresentationsForUserLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RepresentationsForUserQuery,
    RepresentationsForUserQueryVariables
  >
...
export type RepresentationsForUserQueryHookResult = ReturnType<
  typeof useRepresentationsForUserQuery
>;
export type RepresentationsForUserLazyQueryHookResult = ReturnType<
  typeof useRepresentationsForUserLazyQuery
>;
export type RepresentationsForUserQueryResult = Apollo.QueryResult<
  RepresentationsForUserQuery,
  RepresentationsForUserQueryVariables
>;
 ...
 * });
 */
export function useSearchableRepresentationsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SearchableRepresentationsQuery,
    SearchableRepresentationsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    SearchableRepresentationsQuery,
    SearchableRepresentationsQueryVariables
  >(SearchableRepresentationsDocument, options);
}
export function useSearchableRepresentationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchableRepresentationsQuery,
    SearchableRepresentationsQueryVariables
  >
...
export type SearchableRepresentationsQueryHookResult = ReturnType<
  typeof useSearchableRepresentationsQuery
>;
export type SearchableRepresentationsLazyQueryHookResult = ReturnType<
  typeof useSearchableRepresentationsLazyQuery
>;
export type SearchableRepresentationsQueryResult = Apollo.QueryResult<
  SearchableRepresentationsQuery,
  SearchableRepresentationsQueryVariables
>;
 ...
 * });
 */
export function useRepresentationFilterSearchQuery(
  baseOptions: Apollo.QueryHookOptions<
    RepresentationFilterSearchQuery,
    RepresentationFilterSearchQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    RepresentationFilterSearchQuery,
    RepresentationFilterSearchQueryVariables
  >(RepresentationFilterSearchDocument, options);
}
export function useRepresentationFilterSearchLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RepresentationFilterSearchQuery,
    RepresentationFilterSearchQueryVariables
  >
...
export type RepresentationFilterSearchQueryHookResult = ReturnType<
  typeof useRepresentationFilterSearchQuery
>;
export type RepresentationFilterSearchLazyQueryHookResult = ReturnType<
  typeof useRepresentationFilterSearchLazyQuery
>;
export type RepresentationFilterSearchQueryResult = Apollo.QueryResult<
  RepresentationFilterSearchQuery,
  RepresentationFilterSearchQueryVariables
>;
 ...
 * });
 */
export function usePinnedRepresentationsQuery(
  baseOptions?: Apollo.QueryHookOptions<
    PinnedRepresentationsQuery,
    PinnedRepresentationsQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    PinnedRepresentationsQuery,
    PinnedRepresentationsQueryVariables
  >(PinnedRepresentationsDocument, options);
}
export function usePinnedRepresentationsLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    PinnedRepresentationsQuery,
    PinnedRepresentationsQueryVariables
  >
...
export type PinnedRepresentationsQueryHookResult = ReturnType<
  typeof usePinnedRepresentationsQuery
>;
export type PinnedRepresentationsLazyQueryHookResult = ReturnType<
  typeof usePinnedRepresentationsLazyQuery
>;
export type PinnedRepresentationsQueryResult = Apollo.QueryResult<
  PinnedRepresentationsQuery,
  PinnedRepresentationsQueryVariables
>;
 ...
 * });
 */
export function useRoisForRepresentationQuery(
  baseOptions: Apollo.QueryHookOptions<
    RoisForRepresentationQuery,
    RoisForRepresentationQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<
    RoisForRepresentationQuery,
    RoisForRepresentationQueryVariables
  >(RoisForRepresentationDocument, options);
}
export function useRoisForRepresentationLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    RoisForRepresentationQuery,
    RoisForRepresentationQueryVariables
  >
...
export type RoisForRepresentationQueryHookResult = ReturnType<
  typeof useRoisForRepresentationQuery
>;
export type RoisForRepresentationLazyQueryHookResult = ReturnType<
  typeof useRoisForRepresentationLazyQuery
>;
export type RoisForRepresentationQueryResult = Apollo.QueryResult<
  RoisForRepresentationQuery,
  RoisForRepresentationQueryVariables
>;
 ...
 * });
 */
export function useDetailRoiQuery(
  baseOptions: Apollo.QueryHookOptions<DetailRoiQuery, DetailRoiQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailRoiQuery, DetailRoiQueryVariables>(
    DetailRoiDocument,
    options
  );
}
export function useDetailRoiLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailRoiQuery,
    DetailRoiQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DetailRoiQuery, DetailRoiQueryVariables>(
    DetailRoiDocument,
    options
  );
}
export type DetailRoiQueryHookResult = ReturnType<typeof useDetailRoiQuery>;
export type DetailRoiLazyQueryHookResult = ReturnType<
  typeof useDetailRoiLazyQuery
>;
export type DetailRoiQueryResult = Apollo.QueryResult<
  DetailRoiQuery,
  DetailRoiQueryVariables
>;
 ...
 * });
 */
export function useDetailSampleQuery(
  baseOptions: Apollo.QueryHookOptions<
    DetailSampleQuery,
    DetailSampleQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailSampleQuery, DetailSampleQueryVariables>(
    DetailSampleDocument,
    options
  );
}
export function useDetailSampleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailSampleQuery,
    DetailSampleQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DetailSampleQuery, DetailSampleQueryVariables>(
    DetailSampleDocument,
    options
  );
}
export type DetailSampleQueryHookResult = ReturnType<
  typeof useDetailSampleQuery
>;
export type DetailSampleLazyQueryHookResult = ReturnType<
  typeof useDetailSampleLazyQuery
>;
export type DetailSampleQueryResult = Apollo.QueryResult<
  DetailSampleQuery,
  DetailSampleQueryVariables
>;
 ...
 * });
 */
export function useMySamplesQuery(
  baseOptions?: Apollo.QueryHookOptions<MySamplesQuery, MySamplesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MySamplesQuery, MySamplesQueryVariables>(
    MySamplesDocument,
    options
  );
}
export function useMySamplesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MySamplesQuery,
    MySamplesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MySamplesQuery, MySamplesQueryVariables>(
    MySamplesDocument,
    options
  );
}
export type MySamplesQueryHookResult = ReturnType<typeof useMySamplesQuery>;
export type MySamplesLazyQueryHookResult = ReturnType<
  typeof useMySamplesLazyQuery
>;
export type MySamplesQueryResult = Apollo.QueryResult<
  MySamplesQuery,
  MySamplesQueryVariables
>;
 ...
 * });
 */
export function useSearchSampleQuery(
  baseOptions?: Apollo.QueryHookOptions<
    SearchSampleQuery,
    SearchSampleQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<SearchSampleQuery, SearchSampleQueryVariables>(
    SearchSampleDocument,
    options
  );
}
export function useSearchSampleLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    SearchSampleQuery,
    SearchSampleQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<SearchSampleQuery, SearchSampleQueryVariables>(
    SearchSampleDocument,
    options
  );
}
export type SearchSampleQueryHookResult = ReturnType<
  typeof useSearchSampleQuery
>;
export type SearchSampleLazyQueryHookResult = ReturnType<
  typeof useSearchSampleLazyQuery
>;
export type SearchSampleQueryResult = Apollo.QueryResult<
  SearchSampleQuery,
  SearchSampleQueryVariables
>;
 ...
 * });
 */
export function useDetailTableQuery(
  baseOptions: Apollo.QueryHookOptions<
    DetailTableQuery,
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<DetailTableQuery, DetailTableQueryVariables>(
    DetailTableDocument,
    options
  );
}
export function useDetailTableLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    DetailTableQuery,
    DetailTableQueryVariables
  >
  ...
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<DetailTableQuery, DetailTableQueryVariables>(
    DetailTableDocument,
    options
  );
}
export type DetailTableQueryHookResult = ReturnType<typeof useDetailTableQuery>;
export type DetailTableLazyQueryHookResult = ReturnType<
  typeof useDetailTableLazyQuery
>;
export type DetailTableQueryResult = Apollo.QueryResult<
  DetailTableQuery,
  DetailTableQueryVariables
>;
 ...
 * });
 */
export function useMyTablesQuery(
  baseOptions?: Apollo.QueryHookOptions<MyTablesQuery, MyTablesQueryVariables>
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useQuery<MyTablesQuery, MyTablesQueryVariables>(
    MyTablesDocument,
    options
  );
}
export function useMyTablesLazyQuery(
  baseOptions?: Apollo.LazyQueryHookOptions<
    MyTablesQuery,
    MyTablesQueryVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useLazyQuery<MyTablesQuery, MyTablesQueryVariables>(
    MyTablesDocument,
    options
  );
}
export type MyTablesQueryHookResult = ReturnType<typeof useMyTablesQuery>;
export type MyTablesLazyQueryHookResult = ReturnType<
  typeof useMyTablesLazyQuery
>;
export type MyTablesQueryResult = Apollo.QueryResult<
  MyTablesQuery,
  MyTablesQueryVariables
>;
 ...
 * });
 */
export function useMyExperimentsEventSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    MyExperimentsEventSubscription,
    MyExperimentsEventSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<
    MyExperimentsEventSubscription,
    MyExperimentsEventSubscriptionVariables
  >(MyExperimentsEventDocument, options);
}
export type MyExperimentsEventSubscriptionHookResult = ReturnType<
  typeof useMyExperimentsEventSubscription
>;
export type MyExperimentsEventSubscriptionResult =
  Apollo.SubscriptionResult<MyExperimentsEventSubscription>;
 ...
 * });
 */
export function useMyRepresentationsEventSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    MyRepresentationsEventSubscription,
    MyRepresentationsEventSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<
    MyRepresentationsEventSubscription,
    MyRepresentationsEventSubscriptionVariables
  >(MyRepresentationsEventDocument, options);
}
export type MyRepresentationsEventSubscriptionHookResult = ReturnType<
  typeof useMyRepresentationsEventSubscription
>;
export type MyRepresentationsEventSubscriptionResult =
  Apollo.SubscriptionResult<MyRepresentationsEventSubscription>;
 ...
 * });
 */
export function useMyRepresentationsOriginSubscription(
  baseOptions: Apollo.SubscriptionHookOptions<
  ...
  return Apollo.useSubscription<
    MyRepresentationsOriginSubscription,
    MyRepresentationsOriginSubscriptionVariables
  >(MyRepresentationsOriginDocument, options);
}
export type MyRepresentationsOriginSubscriptionHookResult = ReturnType<
  typeof useMyRepresentationsOriginSubscription
>;
export type MyRepresentationsOriginSubscriptionResult =
  Apollo.SubscriptionResult<MyRepresentationsOriginSubscription>;
...
export function useWatchRoisSubscription(
  ...
  return Apollo.useSubscription<
    WatchRoisSubscription,
    WatchRoisSubscriptionVariables
  >(WatchRoisDocument, options);
}
export type WatchRoisSubscriptionHookResult = ReturnType<
  typeof useWatchRoisSubscription
>;
export type WatchRoisSubscriptionResult =
  Apollo.SubscriptionResult<WatchRoisSubscription>;
 ...
 * });
 */
export function useMySamplesEventSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    MySamplesEventSubscription,
    MySamplesEventSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<
    MySamplesEventSubscription,
    MySamplesEventSubscriptionVariables
  >(MySamplesEventDocument, options);
}
export type MySamplesEventSubscriptionHookResult = ReturnType<
  typeof useMySamplesEventSubscription
>;
export type MySamplesEventSubscriptionResult =
  Apollo.SubscriptionResult<MySamplesEventSubscription>;
 ...
 * });
 */
export function useMyTablesEventSubscription(
  baseOptions?: Apollo.SubscriptionHookOptions<
    MyTablesEventSubscription,
    MyTablesEventSubscriptionVariables
  >
) {
  const options = { ...defaultOptions, ...baseOptions };
  return Apollo.useSubscription<
    MyTablesEventSubscription,
    MyTablesEventSubscriptionVariables
  >(MyTablesEventDocument, options);
}
export type MyTablesEventSubscriptionHookResult = ReturnType<
  typeof useMyTablesEventSubscription
>;
export type MyTablesEventSubscriptionResult =
  Apollo.SubscriptionResult<MyTablesEventSubscription>;
